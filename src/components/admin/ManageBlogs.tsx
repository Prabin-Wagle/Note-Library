...
interface Blog {
  id: string;
  title: string;
  author: string; // Assuming author is a string, adjust if it's an object or ID
  content: string;
  excerpt: string;
  coverImage: string;
  tags: string[];
  ...
  createdAt: any; // Or a more specific type like firebase.firestore.Timestamp
  updatedAt?: any;
}
  ...
  const handleFormSubmit = async (formData: any) => {
    try {
      if (editingBlog) {
        ...
        // Add new blog
        await addDoc(collection(db, 'blogs'), { ...formData, author: 'Admin', createdAt: serverTimestamp(), updatedAt: serverTimestamp() }); // Assuming author for now
